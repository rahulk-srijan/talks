...
$library_array = array('orginaction', 'opsinaction', 'btoacademy','spotlight','ourtechnology','mi_matters','partner_entrepreneurship','competetowin');
...
function vedio_library_preprocess_html(&$vars) {
    global $subsite_home_page_url;
    drupal_add_css(drupal_get_path('theme', 'vedio_library') . '/css/global.base.IE8.css', array(
        'group' => CSS_THEME,
        'browsers' => array(
            'IE' => 'lte IE 8',
            '!IE' => FALSE
    ...
    drupal_add_css(drupal_get_path('theme', 'vedio_library') . '/css/global.styles.IE8.css', array(
        'group' => CSS_THEME,
        'browsers' => array(
            'IE' => 'lte IE 8',
            '!IE' => FALSE
    ...
    drupal_add_css(drupal_get_path('theme', 'vedio_library') . '/css/styles.IE8.css', array(
        'group' => CSS_THEME,
        'browsers' => array(
            'IE' => 'lte IE 8',
            '!IE' => FALSE
...
function vedio_library_preprocess_node(&$vars) {
...
function vedio_library_form_comment_form_alter(&$form, &$form_state) {
 ...
 */
function vedio_library_apachesolr_search_noresults() {
    return t('<ul>
